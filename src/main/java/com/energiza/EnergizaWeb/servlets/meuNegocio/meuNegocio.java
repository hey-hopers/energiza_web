...
public class meuNegocio extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!pessoaFJDAO.getPessoaCadastrada(usuarioLogado.getId())) {
        ...
        String json = String.format(
            ...
            "}" +
            "}",
            escapeJson(pessoa.getNome()),
            escapeJson(pessoa.getDocumento()),
            escapeJson(pessoa.getCep()),
            escapeJson(pessoa.getEndereco()),
            escapeJson(pessoa.getNumero()),
            escapeJson(pessoa.getComplemento()),
            escapeJson(pessoa.getBairro()),
            escapeJson(pessoa.getCidade()),
            escapeJson(pessoa.getEstado()),
            escapeJson(pessoa.getPais())
        );
        out.print(json);
    }
        ...
        try {
            ...
            if (pessoa == null) {
            	...
            	if (pessoaFJDAO.inserirPessoaFJ(pessoa, usuario)) {
                    ...
                    enviarRespostaErro(response, "Erro ao criar negócio");
                }
            	...
            	if (pessoaFJDAO.atualizarPessoaFJ(pessoa)) {
